...
fuel_consumption = 50 # gallons per hour
...
def calculate_range(fuel_capacity, fuel_consumption, true_air_speed):
    range_in_hours = fuel_capacity / fuel_consumption
    range_in_miles = range_in_hours * true_air_speed
    return range_in_miles 

def calculate_endurance(fuel_capacity, fuel_consumption):
    endurance_in_hours = fuel_capacity / fuel_consumption
...
def calculate_cg_position(moment_list, total_weight):
    ...
    cg_postition = total_moment / total_weight
    return cg_postition
...
range = calculate_range(fuel_capacity, fuel_consumption, true_air_speed) 
endurance = calculate_endurance(fuel_capacity, fuel_consumption)
